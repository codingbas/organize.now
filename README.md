...
* Wireframes have been created using Balsamiq Mockups 3. These can be viewed in [documentation/wireframes](https://github.com/codingbas/organize.now/tree/master/documentation/wireframes).
